    ...
    <div class="chat-wrapper">
        ...
        <div class="chat-right">
            ...
            <div class="create-message-for">
                <a class="blue" href="<?php echo SITEURL;?>student/chat-student.php?id=<?php echo $id; ?>">Student</a>
                <a href="<?php echo SITEURL;?>student/chat-teacher.php?id=<?php echo $id; ?>">Teacher</a>
            </div>
            
            <div class="create-message-to">
                <form action="../includes/chat-student-to-student.inc.php" method="POST">
