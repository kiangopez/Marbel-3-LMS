<?php include "partials-teacher/header.php"; ?>
    ...
    <section class="dashboard wrapper column" id="dashboard">
        <div class="heading p-20"><h2>Students</h2></div>
        <br>
        <div class="p-20 student-header flex">
            <div class="search">
                <form class="flex" action="<?php echo SITEURL;?>teacher/student-search.php" method="POST">
        ...
        <?php
            ...
            for($page = 1; $page <= $number_of_pages; $page++) {
                ...
                <div class="pagination">
                    <li><a class="<?php echo $active; ?>" href="<?php echo SITEURL;?>teacher/student-evaluation.php?page=<?php echo $page; ?>"><?php echo $page; ?></a></li>
                </div>
                <?php
            }
        ?>
