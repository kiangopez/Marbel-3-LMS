...
?>
    <section class="dashboard wrapper column" id="dashboard">
        ...
        <br><br>
        <div class="p-20">
            <a href="<?php echo SITEURL;?>teacher/add-quiz.php?id=<?php echo $subj_id;?>" class="primary-btn">Add Quiz</a>
        </div>
        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        if($status == "inactive") {
                                            ?>
                                                <a href="<?php echo SITEURL;?>teacher/quiz-status.php?id=<?php echo $quiz_id;?>&status=inactive&subj_id=<?php echo $subj_id; ?>" class="danger-btn">Inactive</a>

                                            <?php
                                        } else if($status == "active"){
                                            ?>
                                                <a href="<?php echo SITEURL;?>teacher/quiz-status.php?id=<?php echo $quiz_id;?>&status=active&subj_id=<?php echo $subj_id; ?>" class="success-btn">Active</a>
                                ...
                                <td>
                                    <div class="actions flex">
                                        <a class="success-btn" href="<?php echo SITEURL;?>teacher/questions.php?id=<?php echo $quiz_id; ?>">Add Questions</a>
                                    </div>
                                </td>
                            </tr>
                            <?php
