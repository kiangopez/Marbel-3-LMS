    ...
    <div class="chat-wrapper">
        ...
        <div class="chat-right">
            ...
            <div class="create-message-for">
                <a href="<?php echo SITEURL;?>teacher/chat-student.php?id=<?php echo $id; ?>">Student</a>
                <a class="blue" href="<?php echo SITEURL;?>teacher/chat-teacher.php?id=<?php echo $id; ?>">Teacher</a>
            </div>
            
            <div class="create-message-to">
                <form action="../includes/chat-teacher-to-teacher.inc.php" method="POST">
