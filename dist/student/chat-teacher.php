...
<section class="dashboard wrapper column" id="dashboard">
    ...
    <div class="chat-wrapper">
        <div class="chat-left">
        <form action="../includes/read-message.inc.php" method="POST">
            <div class="chat-header">
                ...
                <div class="flex gap-20">
                    ...
                    <a class="blue" href="<?php echo SITEURL;?>student/sent-message.php?id=<?php echo $id; ?>">Sent messages</a>
                </div>
            </div>
            <?php
                        ...
                        <div class="chat-message">
                            ...
                            <div class="message-footer">
                                ...
                                <div class="message-btn">
                                    <a href="<?php echo SITEURL;?>student/remove-message.php?id=<?php echo $message_id; ?>&user_id=<?php echo $id;?>" class="danger-btn" onclick="javascript: return confirm('Do you want to remove this message?');">Remove</a>
                                    <a class="primary-btn text-center" href="<?php echo SITEURL;?>student/chat-reply.php?mes_id=<?php echo $message_id; ?>&user_id=<?php echo $id;?>">Reply</a>
                                </div>
                            </div>
                        </div>
                        <?php
        ...
        <div class="chat-right">
            ...
            <div class="create-message-for">
                <a href="<?php echo SITEURL;?>student/chat-student.php?id=<?php echo $id; ?>">Student</a>
                <a class="blue" href="<?php echo SITEURL;?>student/chat-teacher.php?id=<?php echo $id; ?>">Teacher</a>
            </div>
            
            <div class="create-message-to">
                <form action="../includes/chat-student-to-teacher.inc.php" method="POST">
                    ...
                    <?php
                        $sql = "SELECT * FROM teachers_tbl ORDER BY fname ASC";
                        $res = mysqli_query($conn, $sql);
                        $count = mysqli_num_rows($res);
