...
?>
    <section class="dashboard wrapper column" id="dashboard">
        ...
        <div class="quiz p-20 tbl-50 form-wrapper">
            <form action="../includes/admin-add-question.inc.php" method="POST">
                ...
                <a href="<?php echo SITEURL;?>admin/questions.php?id=<?php echo $quiz_id; ?>" class="secondary-btn btn-20 mt-20">Back</a>
            </form>
