                        ...
                        while($rows = mysqli_fetch_assoc($res)) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="secondary-btn" onclick="javascript: return confirm('Do you want to delete this Admin?');" href="<?php echo SITEURL; ?>admin/delete-admin.php?id=<?php echo $id; ?>">Delete</a>
                                </td>
                            </tr>
                            <?php
                        }
