    ...
    <div class="chat-wrapper">
        ...
        <div class="chat-right">
            ...
            <div class="create-message-for">
                <a class="blue" href="<?php echo SITEURL;?>tempadmin/chat-student.php?id=<?php echo $id; ?>">Student</a>
            ...
            <div class="create-message-to">
                <form action="../includes/chat-tempadmin-to-student.inc.php" method="POST">
