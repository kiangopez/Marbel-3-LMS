    ...
    <div class="chat-wrapper">
        ...
        <div class="chat-right">
            ...
            <div class="create-message-for">
                ...
                <a class="blue" href="<?php echo SITEURL;?>tempadmin/chat-teacher.php?id=<?php echo $id; ?>">Teacher</a>
                <a href="<?php echo SITEURL;?>tempadmin/chat-admin.php?id=<?php echo $id; ?>">Admin</a>
            </div>
            
            <div class="create-message-to">
                <form action="../includes/chat-tempadmin-to-teacher.inc.php" method="POST">
