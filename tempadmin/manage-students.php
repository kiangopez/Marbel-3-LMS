...
?>
    <section class="dashboard wrapper column" id="dashboard">
        ...
        <div class="p-20 student-header flex">
            <div class="add-btn">
                <a class="primary-btn" href="<?php echo SITEURL;?>tempadmin/add-students.php">Add Student</a>
            </div>
            <div class="search">
                <form class="flex" action="<?php echo SITEURL;?>tempadmin/student-search.php" method="POST">
            ...
            <?php
                ...
                if($count > 0) {
                    while($row2 = mysqli_fetch_assoc($res2)) {
                        ...
                        <td>       
                            <a class="primary-btn" href="<?php echo SITEURL;?>tempadmin/enrolled-subjects.php?id=<?php echo $id; ?>">View</a>
                        </td>
                        <td>       
                            <a class="primary-btn" href="<?php echo SITEURL;?>tempadmin/view-grades.php?id=<?php echo $id; ?>">View</a>
                        </td>
                        <td>
                            <a class="primary-btn" href="<?php echo SITEURL;?>tempadmin/update-student.php?id=<?php echo $id; ?>">Update</a>
                        </td>
                    </tr>
                    <?php
                    }
        ...
        <?php
            ...
            for($page = 1; $page <= $number_of_pages; $page++) {
                ...
                <div class="pagination">
                    <li><a class="<?php echo $active; ?>" href="<?php echo SITEURL;?>tempadmin/manage-students.php?page=<?php echo $page; ?>"><?php echo $page; ?></a></li>
                </div>
                <?php
            }
        ?>
