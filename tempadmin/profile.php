...
<section class="dashboard wrapper column" id="dashboard">
    ...
    <div class="profile-wrapper mt-20 p-20">
        <div class="left-profile">
            ...
            <a href="<?php echo SITEURL;?>tempadmin/edit-profile.php?id=<?php echo $id; ?>" class="primary-btn">Edit Profile</a>
            <div class="password">
                <a class="blue" href="<?php echo SITEURL;?>tempadmin/change-password.php?id=<?php echo $id; ?>">Change password</a>
            </div>
