...
<?php include "tempadmin-login-check.php"; ?>
...
<body>
      ...
      <div class="header-items-wrapper">
        ...
        <div class="header-items">
            ...
            <div class="dropdown-content">
              <a href="<?php echo SITEURL;?>tempadmin/profile.php?id=<?php echo $id; ?>">Profile</a>
              <a href="<?php echo SITEURL;?>tempadmin/logout.php">Logout</a>
            </div>
        </div>
      </div>
    </header>
    ...
    <nav>
      <div class="wrapper sidebar">
        <ul class="nav-links">
          <li><a href="<?php echo SITEURL;?>tempadmin/home.php"><ion-icon name="home-sharp"></ion-icon>Home</a></li>
          <li><a href="<?php echo SITEURL;?>tempadmin/index.php"><ion-icon name="speedometer-sharp"></ion-icon>Dashboard</a></li>
          <?php
            ...
            if($count_message > 0) {
              ?>
                <li><a href="<?php echo SITEURL;?>tempadmin/chat.php?id=<?php echo $id; ?>"><ion-icon name="chatbubbles-sharp"></ion-icon>Chat <span><?php echo $count_message; ?></span></a></li>
              <?php
            } else {
              ?>
              <li><a href="<?php echo SITEURL;?>tempadmin/chat.php?id=<?php echo $id; ?>"><ion-icon name="chatbubbles-sharp"></ion-icon>Chat</a></li>
              <?php
            }
          ?>
          <li class="label">Menu</li>
          <li><a href="<?php echo SITEURL;?>tempadmin/manage-students.php?page=1"><ion-icon name="document-sharp"></ion-icon>Manage Students</a></li>
        </ul>
      </div>
    </nav>
    <!-- Side Navbar Ends -->