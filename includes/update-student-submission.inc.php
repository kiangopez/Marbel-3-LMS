...
if(isset($_POST['submit'])) {
    ...
    if (!in_array($extension, ['zip', 'pdf', 'docx', 'jpg', 'jpeg', 'png'])) {
        ...
        $_SESSION['fileUpload'] = "<div class='error'>Error: File extension must be 'zip', 'pdf', 'jpeg', 'png', or 'docx'</div>";
        ...
        if (move_uploaded_file($file, $destination)) {
            $sql1 = "UPDATE student_submission SET file = '$filename' WHERE student_submission_id = $student_submission_id;";
