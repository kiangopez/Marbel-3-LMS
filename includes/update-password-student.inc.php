...
if(isset($_POST['submit'])) {
    ...
    if($checkPwd === false) {
        header("location:".SITEURL."student/student-profile.php?error=wrongcurrentpassword&id=$id");
        exit();
    }
    ...
    if (pwdMatch($new_password, $confirm_password) !== false ) {
        header("location:".SITEURL."student/student-profile.php?error=passwordsdontmatch&id=$id");
        exit();
    }
