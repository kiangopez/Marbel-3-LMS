    ...
    if (!in_array($extension, ['zip', 'pdf', 'docx'])) {
        ...
        if (move_uploaded_file($file, $destination)) {
            ...
            if (mysqli_query($conn, $sql1)) {
                ...
                $action_details = "Uploaded file in the subject ".$row3['subject_name']." (".$row3['subject_code'].").";
                $role = "Administrator";

                $sql55 = "INSERT INTO user_log (username, activity_date, action, action_details, role) VALUES ('$user_name' , '$date', 'File Upload', '$action_details', '$role');";
