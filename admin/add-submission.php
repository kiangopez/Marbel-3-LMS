...
?>
    <section class="dashboard wrapper column" id="dashboard">
        ...
        <div class="quiz p-20 tbl-50 form-wrapper">
            <form action="../includes/admin-add-submission.inc.php" method="POST">
                ...
                <a href="<?php echo SITEURL;?>admin/submission.php?id=<?php echo $subj_id; ?>" class="secondary-btn btn-20 mt-20">Back</a>
            </form>
