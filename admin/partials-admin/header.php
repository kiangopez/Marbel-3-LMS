      ...
      <div class="header-items-wrapper">
        ...
        <div class="header-items">
            ...
            <div class="dropdown-content">
              ...
              <a href="<?php echo SITEURL;?>admin/admin-logout.php?id=<?php echo $id; ?>">Logout</a>
            </div>
        </div>
      </div>
    </header>
    ...
    <nav>
      <div class="wrapper sidebar">
        <ul class="nav-links">
          ...
          <li><a href="<?php echo SITEURL;?>admin/manage-sections.php"><ion-icon name="document-sharp"></ion-icon>Manage Sections</a></li>
          ...
          <li><a href="<?php echo SITEURL;?>admin/user-log.php?page=1"><ion-icon name="people-sharp"></ion-icon></ion-icon>User Log</a></li>
        </ul>
      </div>
    </nav>
    <!-- Side Navbar Ends -->