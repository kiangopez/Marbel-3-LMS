    ...
    <div class="chat-wrapper">
        ...
        <div class="chat-right">
            ...
            <div class="create-message-for">
                ...
                <a class="blue" href="<?php echo SITEURL;?>admin/chat-teacher.php?id=<?php echo $id; ?>">Teacher</a>
                <a href="<?php echo SITEURL;?>admin/chat-admin.php?id=<?php echo $id; ?>">Admin</a>
            </div>
            
            <div class="create-message-to">
                <form action="../includes/chat-admin-to-teacher.inc.php" method="POST">
