                        ...
                        while($row = mysqli_fetch_assoc($res)) {
                            ...
                            <div class="ann-container">
                                ...
                                <div class="ann-link">
                                    ...
                                    <a class="blue" href="<?php echo SITEURL;?>admin/ann-delete.php?user=admin&id=<?php echo $annid; ?>&user_id=<?php echo $_SESSION['adminId']; ?>" onclick="javascript: return confirm('Do you want to delete this announcement?');">Delete</a>
                                </div>
                            </div>
                        ...
                        while($row = mysqli_fetch_assoc($res)) {
                            ...
                            <div class="ann-container">
                                ...
                                <div class="ann-link">
                                    ...
                                    <a class="blue" href="<?php echo SITEURL;?>admin/ann-delete.php?user=student&id=<?php echo $annid; ?>&user_id=<?php echo $_SESSION['adminId']; ?>" onclick="javascript: return confirm('Do you want to delete this announcement?');">Delete</a>
                                </div>
                            </div>
                        ...
                        while($row = mysqli_fetch_assoc($res)) {
                            ...
                            <div class="ann-container">
                                ...
                                <div class="ann-link">
                                    ...
                                    <a class="blue" href="<?php echo SITEURL;?>admin/ann-delete.php?user=teacher&id=<?php echo $annid; ?>&user_id=<?php echo $_SESSION['adminId']; ?>" onclick="javascript: return confirm('Do you want to delete this announcement?');">Delete</a>
                                </div>
                            </div>
