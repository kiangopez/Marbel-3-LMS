<?php include "partials-admin/header.php"; ?>
    ...
    <section class="dashboard wrapper column" id="dashboard">
        <div class="heading p-20"><h2><?php echo $subject_code;?> Students</h2></div>
        <br>
        <div class="p-20">
        ...
        <div class="my-students">
            ...
            <div class="enroll-btn p-20">
                <a href="<?php echo SITEURL;?>admin/view-subjects.php?page=1" class="secondary-btn btn-20 mt-20">Back</a>
            </div>
        </div>
        <br><br>
