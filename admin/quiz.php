                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        if($status == "inactive") {
                                            ?>
                                                <a href="<?php echo SITEURL;?>admin/quiz-status.php?id=<?php echo $quiz_id;?>&status=inactive&subj_id=<?php echo $subj_id; ?>&user_id=<?php echo $_SESSION['adminId']; ?>" class="danger-btn">Inactive</a>

                                            <?php
                                        } else if($status == "active"){
                                            ?>
                                                <a href="<?php echo SITEURL;?>admin/quiz-status.php?id=<?php echo $quiz_id;?>&status=active&subj_id=<?php echo $subj_id; ?>&user_id=<?php echo $_SESSION['adminId']; ?>" class="success-btn">Active</a>
