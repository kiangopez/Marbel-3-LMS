<?php include "partials-admin/header.php"; ?>
    ...
    <section class="dashboard wrapper column" id="dashboard">
        <div class="heading p-20"><h2>Teacher Finder</h2></div>
        <br>
        ...
        <table class="tbl-full text-center">
            ...
            <?php
                if(isset($_POST['submit'])) {
                    ...
                    $search = mysqli_real_escape_string($conn, $_POST['teacher_search']);
    
                    $sql = "SELECT * FROM teachers_tbl WHERE URN LIKE '%$search%' OR fname LIKE'%$search%' OR mname LIKE'%$search%' OR lname LIKE'%$search%';";
