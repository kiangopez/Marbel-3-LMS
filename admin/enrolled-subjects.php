        ...
        <div class="student-info p-20">
            <table class="tbl-50">
                <div class="assign-btn">
                    <a href="<?php echo SITEURL;?>admin/manage-enrollsubj.php?id=<?php echo $student_id; ?>" class="primary-btn btn-20 mt-20">Assign</a>
                </div>
                ...
                <tr>
                    <td>Grade & Section:</td>
                    <td><?php echo $category_name." ".$section_name;?></td>
                </tr>
            </table>
        </div>
