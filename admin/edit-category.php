...
<?php
    if(is_numeric($_GET['id'])) {
        ...
        $sql_er = "SELECT * FROM categories_tbl WHERE category_id =". $_GET['id'];
            ...
            <form action="../includes/update-category.inc.php" method="POST" class="pt-20">
                <div>
                    ...
                    <div class="p-0 space-between">
                        ...
                        <div class="p-0 mt-10">
                            <a href="<?php echo SITEURL;?>admin/delete-category.php?id=<?php echo $id; ?>&user_id=<?php echo $_SESSION['adminId']; ?>"  onclick="javascript: return confirm('Do you want to delete this category?');" class="danger-btn">Remove</a>
