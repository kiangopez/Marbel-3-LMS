...
?>
    <section class="dashboard wrapper column" id="dashboard">
                    ...
                    if($count > 0) {
                        while($row = mysqli_fetch_assoc($res)) {
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <form action="../includes/teacher-download-submission.inc.php" method="POST">
                                        <p><?php echo $file;?></p>
                                ...
                                <td>
                                    <form action="../includes/teacher-submission-grade.inc.php" method="POST">
        ...
        <div class="enroll-btn p-20">
            <a href="<?php echo SITEURL;?>teacher/submission.php?id=<?php echo $subject_id; ?>" class="secondary-btn btn-20 mt-20">Back</a>
        </div>
