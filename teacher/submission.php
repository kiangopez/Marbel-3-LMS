...
?>
    <section class="dashboard wrapper column" id="dashboard">
        ...
        <br><br>
        <div class="p-20">
            <a href="<?php echo SITEURL;?>teacher/add-submission.php?id=<?php echo $subj_id;?>" class="primary-btn">Add Submission</a>
        </div>
        <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                        if($status == "inactive") {
                                            ?>
                                                <a href="<?php echo SITEURL;?>teacher/submission-status.php?id=<?php echo $sb_id;?>&status=inactive&subj_id=<?php echo $subj_id; ?>&user_id=<?php echo $_SESSION['teacherId']; ?>" class="danger-btn">Inactive</a>

                                            <?php
                                        } else if($status == "active"){
                                            ?>
                                                <a href="<?php echo SITEURL;?>teacher/submission-status.php?id=<?php echo $sb_id;?>&status=active&subj_id=<?php echo $subj_id; ?>&user_id=<?php echo $_SESSION['teacherId']; ?>" class="success-btn">Active</a>
                                ...
                                <td>
                                    <div class="actions flex">
                                        <a class="success-btn" href="<?php echo SITEURL;?>teacher/view-submissions.php?id=<?php echo $sb_id; ?>">View</a>
                                    </div>
                                </td>
                            </tr>
                            <?php
