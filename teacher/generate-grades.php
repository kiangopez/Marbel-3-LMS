...
<?php include "../teacher/partials-teacher/teacher-login-check.php"; ?>
...
<head>
  ...
  <script
    ...
    <title>Generate Grades | Marbel</title>
</head>
<body>
  <?php
  ...
  ?>
      ...
      <div class="header-pic">
        ...
        <div class="header-items">
          ...
          <div class="dropdown-content">
            ...
            <a href="<?php echo SITEURL;?>teacher/teacher-logout.php">Logout</a>
          </div>
        </div>
      </div>
    </header>
    ...
    <?php
        ...
        //     $sql_student = "SELECT * FROM students_tbl AS s INNER JOIN student_subject AS ss ON s.student_id = ss.student_id WHERE ss.subject_id = $subject_id;";
    ...
    <?php
      if(isset($_POST['submit'])) {
        ...
        $sql_teacher = "SELECT * FROM teachers_tbl WHERE teacher_id = $user_id";
